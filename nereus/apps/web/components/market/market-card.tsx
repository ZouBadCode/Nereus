...
export function MarketCardLarge({ m }: { m: Market }) {
  return (
      ...
      <CardContent className="grid gap-3 p-4 pt-0 md:grid-cols-5">
        ...
        <div className="col-span-2 flex flex-col gap-3">
          ...
          <div className="mt-auto flex gap-2">
            <Button className="flex-1">Buy Yes</Button>
            <Button variant="outline" className="flex-1">Buy No</Button>
          </div>
        </div>
      </CardContent>
    </Card>
...
export function MarketCardMedium({ m }: { m: Market }) {
  return (
    <Card>
...
export function MarketCardSmall({ m }: { m: Market }) {
  return (
    <Card>
      <CardHeader className="pb-2">
